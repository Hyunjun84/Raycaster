...
__inline void fetch_coefficients(float* c, image3d_t vol, int3 org, int3 R, int4 P)
{
    ...
    c[0] = read_imagef(vol, sp2, (int4)(org,1)).r;
    c[1] = read_imagef(vol, sp2, (int4)(org+2*dirx,1)).r;

    c[2] = read_imagef(vol, sp2, (int4)(org+diry-dirz,1)).r;
    c[3] = read_imagef(vol, sp2, (int4)(org+diry+dirz,1)).r;

    c[4] = read_imagef(vol, sp2, (int4)(org+dirx-dirz,1)).r;
    c[5] = read_imagef(vol, sp2, (int4)(org+dirx+dirz,1)).r;

    c[6] = read_imagef(vol, sp2, (int4)(org+dirx-diry,1)).r;
    c[7] = read_imagef(vol, sp2, (int4)(org+dirx+diry,1)).r;
}
