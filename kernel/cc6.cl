...
float3 eval_G_expr_rgb(float* c, float4 u1, float4 u2)
{
    float3 g;
...
float3 eval_G_expr_rg(float* c, float4 u1, float4 u2)
{
    float3 g;
...
float3 eval_G_expr_gb(float* c, float4 u1, float4 u2)
{
    float3 g;
...
float3 eval_G_expr_red(float* c, float4 u1, float4 u2)
{
    float3 g;
...
float3 eval_G_expr_green(float* c, float4 u1, float4 u2)
{
    float3 g;
...
float3 eval_G_expr_blue(float* c, float4 u1, float4 u2)
{
    float3 g;
...
__inline void fetch_coefficients(float* c, image3d_t vol, int3 org, int3 R, int3 vecPx, int3 vecPy, int3 vecPz)
{
    ...
    c10 = read_imagef(vol, sp, (int4)(offset,1)).r; //( 0, 0, 0)
    offset += dirx;
    c23 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirz;
    c22 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c33 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirz;
    c34 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -diry;
    c32 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c20 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirz;
    c19 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c6 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirz;
    c7 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c0 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += diry;
    c2 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirz;
    c1 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c9 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += diry;
    c13 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c26 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirz;
    c27 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c36 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -3*dirx;
    c4 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c14 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += diry;
    c17 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c30 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirz;
    c31 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c18 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -diry;
    c15 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c5 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -diry;
    c3 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c11 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -diry;
    c8 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c21 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += diry;
    c24 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c35 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += diry;
    c37 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c28 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirz;
    c29 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -dirx;
    c16 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += -diry;
    c12 = read_imagef(vol, sp, (int4)(offset,1)).r;
    offset += dirx;
    c25 = read_imagef(vol, sp, (int4)(offset,1)).r;  
}
