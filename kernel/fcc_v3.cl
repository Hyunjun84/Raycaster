...
#define SCALE_G (0.000520833f)   // 6/(2*11520) = n/2*(D_{v_i} - D_{v_j}) = 6 / 2 * (1/11520)
#define SCALE_H (0.002604167f)   // 1/15336 
...
__inline float8 eval_H(float3 p_in, __read_only image3d_t vol)
{
    ...
    float8 H = (float8)(0);
    H.s0 += 3*(((c5+c6+c7+c8+c15+c16+c21+c22)+2*(c1+c2+c3+c13-c14+c18+c23+c24)+3*(-c19-c20)+4*(c17-c25-c26)+5*(c10+c11)+6*(c12)+8*(-c0-c9)+10*(-c4))*X4.y);
    H.s0 += 3*(((-c10-c11+c15+c16+c19+c20)+2*(c13+c14+c18+c23+c24)+3*(-c5-c6-c21-c22)+4*(-c2-c3-c4-c25-c26)+5*(c7+c8)+6*(-c9)+8*(-c0+c1)+16*(c12))*X4.z);
    H.s0 += 6*(((c5+c6)+2*(-c2-c3)+4*(c13+c14)+7*(c15+c16)+8*(-c18-c25-c26)+10*(c17+c23+c24)+11*(-c19-c20-c21-c22)+13*(c7+c8+c10+c11)+16*(c1)+20*(-c4)+38*(-c9)+56*(-c0)+64*(c12))*X2.y*X2.z);
    H.s0 += 6*(((c19+c20+c21+c22+c23+c24+c25+c26)+4*(c15+c16)+5*(-c5-c6-c7-c8-c10-c11)+6*(c12-c13-c14-c17-c18)+8*(-c2-c3)+12*(c9)+18*(c1+c4))*X2.y);
    H.s0 += 6*(((c19+c20+c21+c22+c23+c24+c25+c26)+2*(-c9)+4*(c14+c17)+5*(-c5-c6-c7-c8)+6*(-c13-c15-c16-c18)+8*(-c1-c4-c12)+9*(c10+c11)+18*(c2+c3))*X2.z);
    H.s0 += 6*(((-c14-c15-c16-c17)+6*(c13+c18)+8*(-c5-c6-c7-c8)+10*(c1+c2+c3+c4+c9+c10+c11+c12)+56*(-c0)));
    H.s0 += 12*((2*(c21-c22)+3*(c5-c6+c23-c24+c25-c26)+4*(c19-c20)+6*(c2-c3)+9*(-c7+c8)+16*(-c10+c11))*X3.y*X.z);
    H.s0 += 12*(((-c5-c6-c7-c8-c15-c16+c19+c20-c23-c24+c25+c26)+2*(c9+c14+c21+c22)+4*(-c1+c4-c17)+8*(c0-c12))*X3.y);
    H.s0 += 12*(((-c15+c16)+4*(-c19+c20)+5*(-c5+c6-c21+c22-c23+c24-c25+c26)+8*(-c2+c3)+13*(c7-c8)+25*(c10-c11))*X2.y*X.z);
    H.s0 += 12*((2*(-c15+c16+c19-c20)+3*(c23-c24+c25-c26)+4*(c21-c22)+5*(c5-c6)+6*(c2-c3)+7*(-c7+c8)+14*(-c10+c11))*X.y*X3.z);
    H.s0 += 12*(((c5+c6)+2*(-c17)+3*(-c15-c16)+4*(-c14+c21+c22)+5*(c19+c20-c23-c24+c25+c26)+6*(-c10-c11)+7*(-c7-c8)+8*(-c1+c4)+22*(c9)+24*(c0)+28*(-c12))*X.y*X2.z);
    H.s0 += 12*(((-c19+c20-c21+c22)+2*(c23-c24-c25+c26)+3*(c10-c11)+4*(-c5+c6+c7-c8))*X.y*X.z);
    H.s0 += 12*(((-c21+c22-c23+c24-c25+c26)+2*(-c19+c20)+3*(-c5+c6+c7-c8+c15-c16)+4*(-c2+c3)+5*(c10-c11))*X3.z);
    H.s0 +=   18*(((-c1-c2-c3-c4+c9+c10+c11+c12)+2*(c13-c18))*X4.x);
    H.s0 +=   24*(((c14-c17)+2*(c5+c6-c7-c8)+3*(-c1+c4-c9+c12))*X3.x*X.y);
    H.s0 +=   24*(((c15-c16)+2*(c5-c6+c7-c8)+3*(-c2+c3-c10+c11))*X3.x*X.z);
    H.s0 +=   24*(((-c14-c15-c16-c17)+4*(-c5-c6-c7-c8)+6*(c1+c2+c3+c4+c9+c10+c11+c12-c13-c18)+16*(-c0))*X3.x);
    H.s0 +=   24*(((c14-c17)+4*(c5+c6-c7-c8)+5*(-c1+c4-c9+c12))*X.y);
    H.s0 +=   24*(((c15-c16)+4*(c5-c6+c7-c8)+5*(-c2+c3-c10+c11))*X.z);
    H.s0 +=   36*(((c1+c4+c5+c6+c7+c8-c13+c14+c15+c16+c17+c23+c24+c25+c26)+2*(c10+c11-c19-c20-c21-c22)+3*(-c18)+5*(-c9)+7*(c12)+8*(-c0))*X2.x*X2.y);
    H.s0 +=   36*(((c2+c3+c5+c6+c7+c8+c10+c11-c13+c14+c15+c16+c17+c23+c24+c25+c26)+2*(-c19-c20-c21-c22)+3*(-c18)+4*(-c9)+8*(-c0+c12))*X2.x*X2.z);
    H.s0 +=   36*(((c14+c15+c16+c17+c23+c24+c25+c26)+5*(c5+c6+c7+c8)+6*(c13+c18)+7*(-c1-c2-c3-c4)+9*(-c9-c10-c11-c12)+24*(c0))*X2.x);
    H.s0 +=   36*(((c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+2*(c1-c4+c7+c8+c12+c17)+4*(c18)+8*(-c0))*X.x*X3.y);
    H.s0 +=   36*(((-c15+c16)+3*(c19-c20+c21-c22-c23+c24+c25-c26)+4*(c2-c3)+5*(-c10+c11)+6*(c5-c6)+12*(-c7+c8))*X.x*X2.y*X.z);
    H.s0 +=   36*(((-c10-c11+c19+c20+c21+c22)+2*(-c9+c13-c15-c16+c23+c24+c25+c26)+4*(-c1-c4)+6*(-c18)+8*(-c12)+16*(c0))*X.x*X2.y);
    H.s0 +=   36*((2*(-c9+c14)+3*(c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+4*(c1-c4+c17)+6*(c7+c8)+8*(c12)+12*(c18)+24*(-c0))*X.x*X.y*X2.z);
    H.s0 +=   36*(((-c5-c6+c7+c8-c23-c24+c25+c26)+4*(c9-c12))*X.x*X.y);
    H.s0 +=   36*(((-c10+c11-c15+c16+c19-c20+c21-c22-c23+c24+c25-c26)+2*(c2-c3+c5-c6)+4*(-c7+c8))*X.x*X3.z);
    H.s0 +=   36*(((c19+c20+c21+c22)+2*(c9+c13-c14-c17+c23+c24+c25+c26)+4*(-c2-c3-c12)+5*(-c10-c11)+6*(-c18)+16*(c0))*X.x*X2.z);
    H.s0 +=   36*(((-c5+c6-c7+c8-c23+c24-c25+c26)+4*(c10-c11))*X.x*X.z);
    H.s0 +=   72*(((c23-c24-c25+c26)+2*(c19-c20+c21-c22)+3*(c5-c6-c7+c8)+6*(-c10+c11))*X2.x*X.y*X.z);
    H.s0 +=   72*(((-c14+c17-c23-c24+c25+c26)+2*(c1-c4-c5-c6+c7+c8)+6*(c9-c12))*X2.x*X.y);
    H.s0 +=   72*(((-c15+c16-c23+c24-c25+c26)+2*(c2-c3-c5+c6-c7+c8)+6*(c10-c11))*X2.x*X.z);
    H.s0 +=   72*(((-c19+c20-c21+c22)+2*(c23-c24-c25+c26)+3*(c10-c11)+4*(-c5+c6+c7-c8))*X.x*X.y*X.z);
    H.s0 +=   72*(((c1+c2+c3+c4-c9-c10-c11-c12)+2*(-c13+c18))*X.x);
    H.s1 +=    3*(((-c10-c11+c15+c16+c19+c20)+2*(c13+c14+c17+c23+c24)+3*(-c2-c3-c25-c26)+4*(-c5-c6-c9-c21-c22)+5*(c7+c8)+6*(-c4)+8*(-c0+c1)+16*(c12))*X4.z);
    H.s1 +=    6*(((c1+c4+c5+c6+c7+c8-c13+c14+c15+c16+c17+c23+c24+c25+c26)+2*(c10+c11-c19-c20-c21-c22)+3*(-c18)+5*(-c9)+7*(c12)+8*(-c0))*X4.x);
    H.s1 +=    6*(((c5+c6)+2*(-c2-c3)+4*(c13+c14)+7*(c15+c16)+8*(-c18-c25-c26)+10*(c17+c23+c24)+11*(-c19-c20-c21-c22)+13*(c7+c8+c10+c11)+16*(c1)+20*(-c4)+38*(-c9)+56*(-c0)+64*(c12))*X2.x*X2.z);
    H.s1 +=    6*(((c19+c20+c21+c22+c23+c24+c25+c26)+4*(c15+c16)+5*(-c5-c6-c7-c8-c10-c11)+6*(c12-c13-c14-c17-c18)+8*(-c2-c3)+12*(c9)+18*(c1+c4))*X2.x);
    H.s1 +=    6*(((c19+c20+c21+c22+c23+c24+c25+c26)+2*(-c4)+4*(c13+c18)+5*(-c2-c3)+6*(-c14-c15-c16-c17)+8*(-c1-c9-c10-c11-c12)+12*(c7+c8)+18*(c5+c6))*X2.z);
    H.s1 +=    6*(((-c13-c15-c16-c18)+6*(c14+c17)+8*(-c2-c3-c10-c11)+10*(c1+c4+c5+c6+c7+c8+c9+c12)+56*(-c0)));
    H.s1 +=    9*(((-c2-c3-c15-c16+c19+c20+c25+c26)+2*(-c1+c9-c18-c21-c22)+4*(c4+c14)+5*(-c10-c11)+7*(c7+c8)+8*(-c0-c17)+10*(c12))*X4.y);
    H.s1 +=   12*(((-c15+c16)+3*(c19-c20+c21-c22-c23+c24+c25-c26)+4*(c2-c3)+5*(-c10+c11)+6*(c5-c6)+12*(-c7+c8))*X3.x*X.z);
    H.s1 +=   12*(((-c10-c11+c19+c20+c21+c22)+2*(-c9+c13-c15-c16+c23+c24+c25+c26)+4*(-c1-c4)+6*(-c18)+8*(-c12)+16*(c0))*X3.x);
    H.s1 +=   12* (((-c15+c16)+4*(-c19+c20)+5*(-c5+c6-c21+c22-c23+c24-c25+c26)+8*(-c2+c3)+13*(c7-c8)+25*(c10-c11))*X2.x*X.z);
    H.s1 +=   12*(((-c25-c26)+2*(c13+c15+c16-c19-c20)+3*(-c5-c6+c21+c22)+4*(-c0-c4-c10-c11-c18)+5*(c2+c3)+6*(-c1-c17)+10*(c12)+12*(c9))*X.x*X3.y);
    H.s1 +=   12*( (2*(-c15+c16+c19-c20)+3*(c21-c22-c23+c24)+4*(-c10+c11+c25-c26)+5*(c2-c3)+6*(c5-c6)+11*(-c7+c8))*X.x*X3.z);
    H.s1 +=   12*(((c2+c3)+3*(-c15-c16)+4*(-c9-c13+c23+c24+c25+c26)+5*(c19+c20+c21+c22)+6*(-c17)+8*(-c1-c18)+10*(c4-c10-c11)+12*(-c7-c8)+16*(-c12)+48*(c0))*X.x*X2.z);
    H.s1 +=   12*(((-c19+c20-c23+c24-c25+c26)+2*(-c21+c22)+4*(-c2+c3+c10-c11)+6*(c7-c8))*X.x*X.z);
    H.s1 +=   12*(((c19-c20)+2*(c25-c26)+3*(c10-c11+c15-c16-c21+c22)+6*(c2-c3)+7*(-c7+c8)+9*(-c5+c6))*X3.y*X.z);
    H.s1 +=   12*(((-c15-c16)+2*(-c10-c11-c13)+3*(c7+c8)+6*(-c2-c3+c4+c9)+9*(c5+c6)+12*(c1-c14)+16*(-c0))*X3.y);
    H.s1 +=   12*(((-c21+c22-c23+c24-c25+c26)+2*(c7-c8-c19+c20)+3*(-c2+c3+c15-c16)+4*(-c5+c6)+6*(c10-c11))*X3.z);

    H.s1 +=   18*(((c5+c6+c7+c8+c15+c16+c21+c22)+2*(c1+c2+c3+c13-c14+c18+c23+c24)+3*(-c19-c20)+4*(c17-c25-c26)+5*(c10+c11)+6*(c12)+8*(-c0-c9)+10*(-c4))*X2.x*X2.y);
    H.s1 +=   18*(((c2+c3+c21+c22)+2*(-c7-c8+c13-c14+c15+c16+c23+c24)+3*(c5+c6-c25-c26)+4*(c17-c19-c20)+6*(-c4+c10+c11)+8*(-c0+c12)+10*(-c9))*X2.y*X2.z);
    H.s1 +=   18*((2*(c13+c15+c16+c18+c21+c22)+9*(c2+c3+c10+c11)+12*(-c4-c9+c14+c17)+13*(-c5-c6)+14*(-c1)+15*(-c7-c8)+18*(-c12)+40*(c0))*X2.y);
    H.s1 +=   24*(((c13-c18)+4*(c2+c3-c10-c11)+5*(-c1-c4+c9+c12))*X.x);
    H.s1 +=   24*(((c15-c16)+4*(c2-c3+c10-c11)+5*(-c5+c6-c7+c8))*X.z);

    H.s1 +=   36*(((c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+2*(c1-c4+c7+c8+c12+c17)+4*(c18)+8*(-c0))*X3.x*X.y);
    H.s1 +=   36*((2*(c21-c22)+3*(c5-c6+c23-c24+c25-c26)+4*(c19-c20)+6*(c2-c3)+9*(-c7+c8)+16*(-c10+c11))*X2.x*X.y*X.z);
    H.s1 +=   36*(((-c5-c6-c7-c8-c15-c16+c19+c20-c23-c24+c25+c26)+2*(c9+c14+c21+c22)+4*(-c1+c4-c17)+8*(c0-c12))*X2.x*X.y);
    H.s1 +=   36*(((-c15+c16)+2*(c5-c6-c23+c24)+3*(-c10+c11+c19-c20+c25-c26)+5*(c2-c3)+9*(-c7+c8))*X.x*X2.y*X.z);
    H.s1 +=   36*(((-c15-c16)+2*(c5+c6+c7+c8-c13+c18+c21+c22)+3*(c10+c11)+4*(c1)+5*(-c2-c3)+6*(-c9-c17)+8*(-c12)+10*(c4))*X.x*X2.y);
    H.s1 +=   36*(((c2+c3-c5-c6)+2*(c13-c21-c22)+3*(c15+c16-c19-c20-c23-c24)+4*(c1+c7+c8+c9+c17-c25-c26)+5*(c10+c11)+6*(-c4)+8*(c18)+12*(c12)+28*(-c0))*X.x*X.y*X2.z);
    H.s1 +=   36*(((-c5-c6-c7-c8+c10+c11+c21+c22)+4*(c0-c12))*X.x*X.y);
    H.s1 +=   36*( (2*(-c15+c16-c21+c22)+3*(-c10+c11)+5*(-c2+c3+c5-c6)+9*(c7-c8))*X2.y*X.z);
    H.s1 +=   36*( ((-c15+c16+c19-c20+c21-c22+c23-c24+c25-c26)+2*(c2-c3+c5-c6-c7+c8)+5*(-c10+c11))*X.y*X3.z);
    H.s1 +=   36*( ((c19+c20-c23-c24+c25+c26)+2*(-c7-c8-c13+c14+c21+c22)+4*(-c5-c6+c9-c17)+6*(c4)+8*(c0-c12))*X.y*X2.z);
    H.s1 +=   36*( ((-c2+c3-c21+c22)+2*(c7-c8))*X.y*X.z);
    H.s1 +=   72*(((-c5+c6+c10-c11-c19+c20+c23-c24-c25+c26)+2*(-c21+c22)+3*(-c2+c3)+7*(c7-c8))*X.x*X.y*X.z);
    H.s1 +=   72*(((c1-c4+c5+c6-c7-c8+c9-c12)+2*(-c14+c17))*X.y);

    H.s2 +=    3*(((c2+c3+c21+c22)+2*(-c7-c8+c13-c14+c15+c16+c23+c24)+3*(c5+c6-c25-c26)+4*(c17-c19-c20)+6*(-c4+c10+c11)+8*(-c0+c12)+10*(-c9))*X4.y);
    H.s2 +=    6*(((c2+c3+c5+c6+c7+c8+c10+c11-c13+c14+c15+c16+c17+c23+c24+c25+c26)+2*(-c19-c20-c21-c22)+3*(-c18)+4*(-c9)+8*(-c0+c12))*X4.x);
    H.s2 +=    6*(((c5+c6)+2*(-c2-c3)+4*(c13+c14)+7*(c15+c16)+8*(-c18-c25-c26)+10*(c17+c23+c24)+11*(-c19-c20-c21-c22)+13*(c7+c8+c10+c11)+16*(c1)+20*(-c4)+38*(-c9)+56*(-c0)+64*(c12))*X2.x*X2.y);
    H.s2 +=    6*(((c19+c20+c21+c22+c23+c24+c25+c26)+2*(-c9)+4*(c14+c17)+5*(-c5-c6-c7-c8)+6*(-c13-c15-c16-c18)+8*(-c1-c4-c12)+9*(c10+c11)+18*(c2+c3))*X2.x);
    H.s2 +=    6*( ((c19+c20+c21+c22+c23+c24+c25+c26)+2*(-c4)+4*(c13+c18)+5*(-c2-c3)+6*(-c14-c15-c16-c17)+8*(-c1-c9-c10-c11-c12)+12*(c7+c8)+18*(c5+c6))*X2.y);
    H.s2 +=    6*(((-c13-c14-c17-c18)+6*(c15+c16)+8*(-c1-c4-c9-c12)+10*(c2+c3+c5+c6+c7+c8+c10+c11)+56*(-c0)));


    H.s2 +=    9*(((c2+c3+c5+c6+c21+c22+c25+c26)+2*(-c4-c9-c15-c16-c17-c18-c19-c20)+6*(c7+c8+c10+c11)+8*(-c0-c12))*X4.z);
    H.s2 +=   12*((2*(-c9+c14)+3*(c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+4*(c1-c4+c17)+6*(c7+c8)+8*(c12)+12*(c18)+24*(-c0))*X3.x*X.y);
    H.s2 +=   12*(((c19+c20+c21+c22)+2*(c9+c13-c14-c17+c23+c24+c25+c26)+4*(-c2-c3-c12)+5*(-c10-c11)+6*(-c18)+16*(c0))*X3.x);
    H.s2 +=   12*(((c5+c6)+2*(-c17)+3*(-c15-c16)+4*(-c14+c21+c22)+5*(c19+c20-c23-c24+c25+c26)+6*(-c10-c11)+7*(-c7-c8)+8*(-c1+c4)+22*(c9)+24*(c0)+28*(-c12))*X2.x*X.y);
    H.s2 +=   12*( ((c2+c3-c5-c6)+2*(c13-c21-c22)+3*(c15+c16-c19-c20-c23-c24)+4*(c1+c7+c8+c9+c17-c25-c26)+5*(c10+c11)+6*(-c4)+8*(c18)+12*(c12)+28*(-c0))*X.x*X3.y);
    H.s2 +=   12*(((c2+c3)+3*(-c15-c16)+4*(-c9-c13+c23+c24+c25+c26)+5*(c19+c20+c21+c22)+6*(-c17)+8*(-c1-c18)+10*(c4-c10-c11)+12*(-c7-c8)+16*(-c12)+48*(c0))*X.x*X2.y);
    H.s2 +=   12*( ((c21+c22-c23-c24+c25+c26)+2*(c19+c20)+3*(-c10-c11)+4*(-c1+c4+c9-c12)+6*(-c7-c8)+12*(c0))*X.x*X.y);
    H.s2 +=   12*( ((-c2+c3-c7+c8+c10-c11+c25-c26)+2*(-c5+c6+c21-c22)+3*(c15-c16-c19+c20))*X.x*X3.z);
    H.s2 +=   12*(((c19+c20-c23-c24+c25+c26)+2*(-c7-c8-c13+c14+c21+c22)+4*(-c5-c6+c9-c17)+6*(c4)+8*(c0-c12))*X3.y);
    H.s2 +=   12*( ((-c5+c6+c7-c8-c10+c11+c21-c22)+2*(-c2+c3+c25-c26)+3*(c15-c16-c19+c20))*X.y*X3.z);
    H.s2 +=   18*(((-c10-c11+c15+c16+c19+c20)+2*(c13+c14+c18+c23+c24)+3*(-c5-c6-c21-c22)+4*(-c2-c3-c4-c25-c26)+5*(c7+c8)+6*(-c9)+8*(-c0+c1)+16*(c12))*X2.x*X2.z);
    H.s2 +=   18*(((-c10-c11+c15+c16+c19+c20)+2*(c13+c14+c17+c23+c24)+3*(-c2-c3-c25-c26)+4*(-c5-c6-c9-c21-c22)+5*(c7+c8)+6*(-c4)+8*(-c0+c1)+16*(c12))*X2.y*X2.z);
    H.s2 +=   18*((2*(c13+c14+c17+c18+c19+c20)+8*(c1+c12)+10*(c4+c9)+12*(c15+c16)+13*(-c2-c3-c5-c6)+15*(-c7-c8-c10-c11)+40*(c0))*X2.z);


    H.s2 +=   24*(((c13-c18)+4*(c1+c4-c9-c12)+5*(-c2-c3+c10+c11))*X.x);
    H.s2 +=   24*(((c14-c17)+4*(c1-c4+c9-c12)+5*(-c5-c6+c7+c8))*X.y);
    H.s2 +=   36*(((-c10+c11-c15+c16+c19-c20+c21-c22-c23+c24+c25-c26)+2*(c2-c3+c5-c6)+4*(-c7+c8))*X3.x*X.z);
    H.s2 +=   36*((2*(-c15+c16+c19-c20)+3*(c23-c24+c25-c26)+4*(c21-c22)+5*(c5-c6)+6*(c2-c3)+7*(-c7+c8)+14*(-c10+c11))*X2.x*X.y*X.z);
    H.s2 +=   36*(((-c21+c22-c23+c24-c25+c26)+2*(-c19+c20)+3*(-c5+c6+c7-c8+c15-c16)+4*(-c2+c3)+5*(c10-c11))*X2.x*X.z);
    H.s2 +=   36*((2*(-c15+c16+c19-c20)+3*(c21-c22-c23+c24)+4*(-c10+c11+c25-c26)+5*(c2-c3)+6*(c5-c6)+11*(-c7+c8))*X.x*X2.y*X.z);
    H.s2 +=   36*((2*(-c4-c9+c13+c14-c23-c24)+3*(-c2-c3-c5-c6-c21-c22-c25-c26)+4*(c7+c8+c12+c17+c18)+8*(c1)+10*(c10+c11)+20*(-c0))*X.x*X.y*X2.z);
    H.s2 +=   36*((2*(-c4-c7-c8+c9-c13-c14+c18+c19+c20)+3*(-c15-c16)+4*(c12)+6*(c5+c6)+7*(c2+c3-c10-c11)+8*(-c1))*X.x*X2.z);
    H.s2 +=   36*(((-c5+c6+c7-c8-c19+c20)+2*(c10-c11))*X.x*X.z);
    H.s2 +=   36*(((-c15+c16+c19-c20+c21-c22+c23-c24+c25-c26)+2*(c2-c3+c5-c6-c7+c8)+5*(-c10+c11))*X3.y*X.z);
    H.s2 +=   36*(((-c21+c22-c23+c24-c25+c26)+2*(c7-c8-c19+c20)+3*(-c2+c3+c15-c16)+4*(-c5+c6)+6*(c10-c11))*X2.y*X.z);
    H.s2 +=   36*((2*(c4-c9-c10-c11-c13-c14+c17+c19+c20)+3*(-c15-c16)+4*(c12)+6*(c2+c3)+7*(c5+c6-c7-c8)+8*(-c1))*X.y*X2.z);
    H.s2 +=   36*(((-c2+c3+c10-c11-c19+c20)+2*(c7-c8))*X.y*X.z);
    H.s2 +=   36*(((c2-c3+c5-c6+c7-c8+c10-c11)+2*(-c15+c16))*X3.z);
    H.s2 +=   72*(((-c21+c22+c23-c24-c25+c26)+2*(c10-c11+c15-c16-c19+c20)+3*(-c2+c3-c5+c6)+5*(c7-c8))*X.x*X.y*X.z);
    H.s2 +=   72*(((c2-c3+c5-c6+c7-c8+c10-c11)+2*(-c15+c16))*X.z);

    H.s4 +=    3*(((c19-c20)+2*(c25-c26)+3*(c10-c11+c15-c16-c21+c22)+6*(c2-c3)+7*(-c7+c8)+9*(-c5+c6))*X4.y+
                 ((-c5+c6+c7-c8-c10+c11+c21-c22)+2*(-c2+c3+c25-c26)+3*(c15-c16-c19+c20))*X4.z);
    H.s4 +=    6*(((c23-c24-c25+c26)+2*(c19-c20+c21-c22)+3*(c5-c6-c7+c8)+6*(-c10+c11))*X4.x+
                 ((-c19+c20-c21+c22)+2*(c23-c24-c25+c26)+3*(c10-c11)+4*(-c5+c6+c7-c8))*X2.x);
    H.s4 +=   12*(((-c15+c16)+3*(c19-c20+c21-c22-c23+c24+c25-c26)+4*(c2-c3)+5*(-c10+c11)+6*(c5-c6)+12*(-c7+c8))*X3.x*X.y+
    ...
    H.s4 +=   18*((2*(c21-c22)+3*(c5-c6+c23-c24+c25-c26)+4*(c19-c20)+6*(c2-c3)+9*(-c7+c8)+16*(-c10+c11))*X2.x*X2.y+
    ...
    H.s4 +=   24*(((c2+c3)+3*(-c15-c16)+4*(-c9-c13+c23+c24+c25+c26)+5*(c19+c20+c21+c22)+6*(-c17)+8*(-c1-c18)+10*(c4-c10-c11)+12*(-c7-c8)+16*(-c12)+48*(c0))*X.x*X.y*X.z+
                 ((c15-c16)+4*(c2-c3+c10-c11)+5*(-c5+c6-c7+c8))*X.y+
                 ((c14-c17)+4*(c1-c4+c9-c12)+5*(-c5-c6+c7+c8))*X.z);
    H.s4 +=   36*(((c2+c3-c5-c6)+2*(c13-c21-c22)+3*(c15+c16-c19-c20-c23-c24)+4*(c1+c7+c8+c9+c17-c25-c26)+5*(c10+c11)+6*(-c4)+8*(c18)+12*(c12)+28*(-c0))*X.x*X2.y*X.z+
    ...
    H.s4 +=   54*(((-c15+c16+c19-c20+c21-c22+c23-c24+c25-c26)+2*(c2-c3+c5-c6-c7+c8)+5*(-c10+c11))*X2.y*X2.z);
    H.s4 +=   96*(((c5-c6-c7+c8)));

    H.s5 +=    3*(((-c15+c16)+2*(c5-c6-c23+c24)+3*(-c10+c11+c19-c20+c25-c26)+5*(c2-c3)+9*(-c7+c8))*X4.y+
                 ((-c2+c3-c7+c8+c10-c11+c25-c26)+2*(-c5+c6+c21-c22)+3*(c15-c16-c19+c20))*X4.z);
    H.s5 +=    6*(((c15-c16)+2*(c5-c6+c7-c8)+3*(-c2+c3-c10+c11))*X4.x+
                 ((-c19+c20-c23+c24-c25+c26)+2*(-c21+c22)+4*(-c2+c3+c10-c11)+6*(c7-c8))*X2.y);
    H.s5 +=   12*((2*(c21-c22)+3*(c5-c6+c23-c24+c25-c26)+4*(c19-c20)+6*(c2-c3)+9*(-c7+c8)+16*(-c10+c11))*X.x*X3.y+
    ...
    H.s5 +=   18*(((-c15+c16)+3*(c19-c20+c21-c22-c23+c24+c25-c26)+4*(c2-c3)+5*(-c10+c11)+6*(c5-c6)+12*(-c7+c8))*X2.x*X2.y+
    ...
    H.s5 +=   24*(((c23-c24-c25+c26)+2*(c19-c20+c21-c22)+3*(c5-c6-c7+c8)+6*(-c10+c11))*X3.x*X.y+
    ...
    H.s5 +=   36*((2*(-c9+c14)+3*(c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+4*(c1-c4+c17)+6*(c7+c8)+8*(c12)+12*(c18)+24*(-c0))*X2.x*X.y*X.z+
                 ((-c19+c20-c21+c22)+2*(c23-c24-c25+c26)+3*(c10-c11)+4*(-c5+c6+c7-c8))*X2.x*X.y+
    ...
    H.s5 +=   54*(((-c10+c11-c15+c16+c19-c20+c21-c22-c23+c24+c25-c26)+2*(c2-c3+c5-c6)+4*(-c7+c8))*X2.x*X2.z);
    H.s5 +=   96*(((c2-c3-c10+c11)));

    H.s6 +=    3*(((-c25-c26)+2*(c13+c15+c16-c19-c20)+3*(-c5-c6+c21+c22)+4*(-c0-c4-c10-c11-c18)+5*(c2+c3)+6*(-c1-c17)+10*(c12)+12*(c9))*X4.y+
                 (2*(-c4-c9+c13+c14-c23-c24)+3*(-c2-c3-c5-c6-c21-c22-c25-c26)+4*(c7+c8+c12+c17+c18)+8*(c1)+10*(c10+c11)+20*(-c0))*X4.z);
    H.s6 +=    6*(((c14-c17)+2*(c5+c6-c7-c8)+3*(-c1+c4-c9+c12))*X4.x+
                 ((c21+c22-c23-c24+c25+c26)+2*(c19+c20)+3*(-c10-c11)+4*(-c1+c4+c9-c12)+6*(-c7-c8)+12*(c0))*X2.z);
    H.s6 +=   12*(((c5+c6+c7+c8+c15+c16+c21+c22)+2*(c1+c2+c3+c13-c14+c18+c23+c24)+3*(-c19-c20)+4*(c17-c25-c26)+5*(c10+c11)+6*(c12)+8*(-c0-c9)+10*(-c4))*X.x*X3.y+
    ...
    H.s6 +=   18*((2*(-c9+c14)+3*(c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+4*(c1-c4+c17)+6*(c7+c8)+8*(c12)+12*(c18)+24*(-c0))*X2.x*X2.z+
    ...
    H.s6 +=   24*(((c1+c4+c5+c6+c7+c8-c13+c14+c15+c16+c17+c23+c24+c25+c26)+2*(c10+c11-c19-c20-c21-c22)+3*(-c18)+5*(-c9)+7*(c12)+8*(-c0))*X3.x*X.y+
    ...
    H.s6 +=   36*(((-c15+c16)+3*(c19-c20+c21-c22-c23+c24+c25-c26)+4*(c2-c3)+5*(-c10+c11)+6*(c5-c6)+12*(-c7+c8))*X2.x*X.y*X.z+
    ...
    H.s6 +=   54*(((c10+c11+c15+c16-c19-c20-c21-c22-c23-c24-c25-c26)+2*(c1-c4+c7+c8+c12+c17)+4*(c18)+8*(-c0))*X2.x*X2.y);
    H.s6 +=   96*(((c1-c4-c9+c12)));

    H.lo = shuffle(H.lo, P.hi);
    H.hi = shuffle(H.hi, P.hi);
    H.s456 *= convert_float3(R);
