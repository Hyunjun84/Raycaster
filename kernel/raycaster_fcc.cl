...
__kernel void raycast(__write_only image2d_t Position,
                          __read_only image3d_t v000, 
                          __read_only image3d_t v011, 
                          __read_only image3d_t v101, 
                          __read_only image3d_t v110, 
                          __global float8* Rays, 
                          float4 scale, 
                          int4 dim, 
                          float level, 
                          __global int2* buf)
{
    ...
    for(i=0; i<max_iter; i++) {
        p = p+dir.xyz;
        voxel = eval_fcc(p, v000, v011, v101, v110);
